                                      ...
                                      Expanded(
                                        child: DecoratedBox(
                                          decoration: BoxDecoration(
                                              color: data.author ==null ?const Color(0x66818181):null,
                                              borderRadius: const BorderRadius.all(Radius.circular(25)),
                                              border:data.author == null? Border.all(
                                                  width: 1,
                                                  color: const Color(0x6614181e)
                                              ):Border.all(
                                                  width: 1.5,
                                                  color: const Color(0x66818181)
                                              )
                                          ),
                                          child: TextButton(
                                            onPressed: () {
                                            ...
                                            child: Text(
                                              ...
                                              style: GoogleFonts.plusJakartaSans(
                                                color:data.author ==null ?const Color(0xffffffff) :const Color(0x9914181e),
                                                fontSize: 16,
                                                fontWeight: FontWeight.w600,
                                              ),
                                            ),
